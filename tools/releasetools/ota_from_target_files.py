...
""" % bcb_dev)
  ...
  if GetBuildProp("ro.bootleg.display.version", OPTIONS.info_dict) is not None:
    buildid = GetBuildProp("ro.bootleg.buildshort", OPTIONS.info_dict)
...
""" % bcb_dev)
  ...
  common.ZipWriteStr(output_zip, "META-INF/org/bootleggers/releasekey",
